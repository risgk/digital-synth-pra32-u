...
uint8_t g_preset_table_FILTER_EG_AMT  [] = {64 , 64 , 100, 16 , 112, 64 , 112, 64 ,   64 , 64 , 100, 16 , 112, 64 , 112, 64 };
...
uint8_t g_preset_table_EG_DECAY       [] = {0  , 0  , 48 , 96 , 96 , 0  , 96 , 0  ,   0  , 0  , 48 , 96 , 96 , 0  , 96 , 0  };
uint8_t g_preset_table_EG_SUSTAIN     [] = {127, 127, 0  , 0  , 0  , 127, 0  , 127,   127, 127, 0  , 0  , 0  , 127, 0  , 127};
uint8_t g_preset_table_EG_RELEASE     [] = {0  , 64 , 32 , 32 , 96 , 0  , 96 , 0  ,   0  , 64 , 32 , 32 , 96 , 0  , 96 , 0  };
...
uint8_t g_preset_table_AMP_DECAY      [] = {0  , 0  , 0  , 0  , 96 , 0  , 96 , 0  ,   0  , 0  , 0  , 0  , 96 , 0  , 96 , 0  };
uint8_t g_preset_table_AMP_SUSTAIN    [] = {127, 127, 127, 127, 0  , 127, 0  , 127,   127, 127, 127, 127, 0  , 127, 0  , 127};
uint8_t g_preset_table_AMP_RELEASE    [] = {0  , 64 , 32 , 32 , 96 , 0  , 96 , 0  ,   0  , 64 , 32 , 32 , 96 , 0  , 96 , 0  };
