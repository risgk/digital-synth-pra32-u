...
uint8_t g_preset_table_OSC_1_MORPH    [] = {64 , 64 , 0  , 64 , 64 , 0  , 66 , 0  ,   64 , 64 , 0  , 64 , 64 , 0  , 66 , 0  };
uint8_t g_preset_table_MIXER_SUB_OSC  [] = {127, 64 , 64 , 64 , 127, 64 , 64 , 64 ,   127, 64 , 64 , 64 , 127, 64 , 64 , 64 };

uint8_t g_preset_table_OSC_2_WAVE     [] = {0  , 0  , 127, 0  , 0  , 0  , 0  , 0  ,   0  , 0  , 127, 0  , 0  , 0  , 0  , 0  };
...
uint8_t g_preset_table_MIXER_OSC_MIX  [] = {64 , 32 , 32 , 32 , 64 , 64 , 32 , 0  ,   64 , 32 , 32 , 32 , 64 , 64 , 32 , 0  };

uint8_t g_preset_table_FILTER_CUTOFF  [] = {115, 115, 73 , 121, 61 , 115, 127, 127,   115, 115, 73 , 121, 61 , 115, 127, 127};
uint8_t g_preset_table_FILTER_RESO    [] = {64 , 64 , 32 , 32 , 32 , 64 , 0  , 0  ,   64 , 64 , 32 , 32 , 32 , 64 , 0  , 0  };
uint8_t g_preset_table_FILTER_EG_AMT  [] = {64 , 64 , 112, 4  , 124, 64 , 64 , 64 ,   64 , 64 , 112, 4  , 124, 64 , 64 , 64 };
...
uint8_t g_preset_table_LFO_DEPTH      [] = {8  , 64 , 64 , 64 , 0  , 127, 64 , 0  ,   8  , 64 , 64 , 64 , 0  , 127, 64 , 0  };
uint8_t g_preset_table_LFO_FADE_TIME  [] = {0  , 64 , 64 , 64 , 0  , 0  , 64 , 0  ,   0  , 64 , 64 , 64 , 0  , 0  , 64 , 0  };

uint8_t g_preset_table_LFO_OSC_AMT    [] = {80 , 80 , 80 , 80 , 80 , 95 , 80 , 64 ,   80 , 80 , 80 , 80 , 80 , 95 , 80 , 64 };
...
uint8_t g_preset_table_P_BEND_RANGE   [] = {12 , 12 , 12 , 12 , 12 , 2  , 12 , 12 ,   12 , 12 , 12 , 12 , 12 , 2  , 12 , 12 };
