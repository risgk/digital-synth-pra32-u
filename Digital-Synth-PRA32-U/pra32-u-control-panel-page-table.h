...
PRA32_U_ControlPanelPage g_control_panel_page_table_b[] = {
  ...
  { "Page=B-02 ", "Seq 0     ",   "Seq       ", "Pitch 0   ", SEQ_PITCH_0    ,   "Seq       ", "Velo 0    ", SEQ_VELO_0     ,   "Panel     ", "Pitch     ", PANEL_PITCH    , },
  { "Page=B-03 ", "Seq 1     ",   "Seq       ", "Pitch 1   ", SEQ_PITCH_1    ,   "Seq       ", "Velo 1    ", SEQ_VELO_1     ,   "Panel     ", "Pitch     ", PANEL_PITCH    , },
  { "Page=B-04 ", "Seq 2     ",   "Seq       ", "Pitch 2   ", SEQ_PITCH_2    ,   "Seq       ", "Velo 2    ", SEQ_VELO_2     ,   "Panel     ", "Pitch     ", PANEL_PITCH    , },
  { "Page=B-05 ", "Seq 3     ",   "Seq       ", "Pitch 3   ", SEQ_PITCH_3    ,   "Seq       ", "Velo 3    ", SEQ_VELO_3     ,   "Panel     ", "Pitch     ", PANEL_PITCH    , },
  { "Page=B-06 ", "Seq 4     ",   "Seq       ", "Pitch 4   ", SEQ_PITCH_4    ,   "Seq       ", "Velo 4    ", SEQ_VELO_4     ,   "Panel     ", "Pitch     ", PANEL_PITCH    , },
  { "Page=B-07 ", "Seq 5     ",   "Seq       ", "Pitch 5   ", SEQ_PITCH_5    ,   "Seq       ", "Velo 5    ", SEQ_VELO_5     ,   "Panel     ", "Pitch     ", PANEL_PITCH    , },
  { "Page=B-08 ", "Seq 6     ",   "Seq       ", "Pitch 6   ", SEQ_PITCH_6    ,   "Seq       ", "Velo 6    ", SEQ_VELO_6     ,   "Panel     ", "Pitch     ", PANEL_PITCH    , },
  { "Page=B-09 ", "Seq 7     ",   "Seq       ", "Pitch 7   ", SEQ_PITCH_7    ,   "Seq       ", "Velo 7    ", SEQ_VELO_7     ,   "Panel     ", "Pitch     ", PANEL_PITCH    , },
  { "Page=B-10 ", "Seq a     ",   "Seq       ", "Tempo     ", SEQ_TEMPO      ,   "          ", "          ", 0xFF           ,   "Panel     ", "Pitch     ", PANEL_PITCH    , },
...
PRA32_U_ControlPanelPage g_control_panel_page_table_c[] = {
  { "Page=C-00 ", "Write 8   ",   "Write     ", "Program  8", WR_PROGRAM_8   ,   "Write     ", "Program  9", WR_PROGRAM_9   ,   "Panel     ", "Pitch     ", PANEL_PITCH    , },
  { "Page=C-01 ", "Write 10  ",   "Write     ", "Program 10", WR_PROGRAM_10  ,   "Write     ", "Program 11", WR_PROGRAM_11  ,   "Panel     ", "Pitch     ", PANEL_PITCH    , },
  { "Page=C-02 ", "Write 12  ",   "Write     ", "Program 12", WR_PROGRAM_12  ,   "Write     ", "Program 13", WR_PROGRAM_13  ,   "Panel     ", "Pitch     ", PANEL_PITCH    , },
  { "Page=C-03 ", "Write 14  ",   "Write     ", "Program 14", WR_PROGRAM_14  ,   "Write     ", "Program 15", WR_PROGRAM_15  ,   "Panel     ", "Pitch     ", PANEL_PITCH    , },
  { "Page=C-04 ", "Write a   ",   "Write     ", "Panel Prms", WR_PANEL_PRMS  ,   "          ", "          ", 0xFF           ,   "Panel     ", "Pitch     ", PANEL_PITCH    , },
};

PRA32_U_ControlPanelPage g_control_panel_page_table_d[] = {
  { "Page=D-00 ", "Read 0    ",   "Read      ", "Program  0", RD_PROGRAM_0   ,   "Read      ", "Program  1", RD_PROGRAM_1   ,   "Panel     ", "Pitch     ", PANEL_PITCH    , },
  { "Page=D-01 ", "Read 2    ",   "Read      ", "Program  2", RD_PROGRAM_2   ,   "Read      ", "Program  3", RD_PROGRAM_3   ,   "Panel     ", "Pitch     ", PANEL_PITCH    , },
  { "Page=D-02 ", "Read 4    ",   "Read      ", "Program  4", RD_PROGRAM_4   ,   "Read      ", "Program  5", RD_PROGRAM_5   ,   "Panel     ", "Pitch     ", PANEL_PITCH    , },
  { "Page=D-03 ", "Read 6    ",   "Read      ", "Program  6", RD_PROGRAM_6   ,   "Read      ", "Program  7", RD_PROGRAM_7   ,   "Panel     ", "Pitch     ", PANEL_PITCH    , },
  { "Page=D-04 ", "Read 8    ",   "Read      ", "Program  8", RD_PROGRAM_8   ,   "Read      ", "Program  9", RD_PROGRAM_9   ,   "Panel     ", "Pitch     ", PANEL_PITCH    , },
  { "Page=D-05 ", "Read 10   ",   "Read      ", "Program 10", RD_PROGRAM_10  ,   "Read      ", "Program 11", RD_PROGRAM_11  ,   "Panel     ", "Pitch     ", PANEL_PITCH    , },
  { "Page=D-06 ", "Read 12   ",   "Read      ", "Program 12", RD_PROGRAM_12  ,   "Read      ", "Program 13", RD_PROGRAM_13  ,   "Panel     ", "Pitch     ", PANEL_PITCH    , },
  { "Page=D-07 ", "Read 14   ",   "Read      ", "Program 14", RD_PROGRAM_14  ,   "Read      ", "Program 15", RD_PROGRAM_15  ,   "Panel     ", "Pitch     ", PANEL_PITCH    , },
  { "Page=D-08 ", "Read a    ",   "Read      ", "Panel Prms", RD_PANEL_PRMS  ,   "          ", "          ", 0xFF           ,   "Panel     ", "Pitch     ", PANEL_PITCH    , },
};
