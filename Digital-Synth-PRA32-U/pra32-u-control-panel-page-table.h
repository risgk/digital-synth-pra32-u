...
struct PRA32_U_ControlPanelPage {
  ...
  { "Page=18   ", "Write a   ",   "Write     ", "to Pgm  #8", WR_BY_PANEL_8  ,   "Write     ", "to Pgm  #9", WR_BY_PANEL_9  ,   "          ", "          ", 0xFF           , },
  { "Page=19   ", "Write b   ",   "Write     ", "to Pgm #10", WR_BY_PANEL_10 ,   "Write     ", "to Pgm #11", WR_BY_PANEL_11 ,   "          ", "          ", 0xFF           , },
  { "Page=20   ", "Write c   ",   "Write     ", "to Pgm #12", WR_BY_PANEL_12 ,   "Write     ", "to Pgm #13", WR_BY_PANEL_13 ,   "          ", "          ", 0xFF           , },
  { "Page=21   ", "Write d   ",   "Write     ", "to Pgm #14", WR_BY_PANEL_14 ,   "Write     ", "to Pgm #15", WR_BY_PANEL_15 ,   "          ", "          ", 0xFF           , },
  { "Page=22   ", "Program a ",   "Program   ", "Change  #0", PC_BY_PANEL_0  ,   "Program   ", "Change  #1", PC_BY_PANEL_1  ,   "          ", "          ", 0xFF           , },
  { "Page=23   ", "Program b ",   "Program   ", "Change  #2", PC_BY_PANEL_2  ,   "Program   ", "Change  #3", PC_BY_PANEL_3  ,   "          ", "          ", 0xFF           , },
  { "Page=24   ", "Program c ",   "Program   ", "Change  #4", PC_BY_PANEL_4  ,   "Program   ", "Change  #5", PC_BY_PANEL_5  ,   "          ", "          ", 0xFF           , },
  { "Page=25   ", "Program d ",   "Program   ", "Change  #6", PC_BY_PANEL_6  ,   "Program   ", "Change  #7", PC_BY_PANEL_7  ,   "          ", "          ", 0xFF           , },
  { "Page=26   ", "Program e ",   "Program   ", "Change  #8", PC_BY_PANEL_8  ,   "Program   ", "Change  #9", PC_BY_PANEL_9  ,   "          ", "          ", 0xFF           , },
