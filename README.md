...
- Prebuilt UF2 files ("bin")
    - "Digital-Synth-PRA32-U-2.5.0-Pimoroni-Pico-Audio-Pack.uf2" is for Raspberry Pi Pico and Pimoroni Pico Audio Pack
...
**Digital Synth PRA32-U v2.5.0 by ISGK Instruments (Ryo Ishigaki)**

To the extent possible under law, ISGK Instruments (Ryo Ishigaki)
has waived all copyright and related or neighboring rights
to Digital Synth PRA32-U v2.5.0.
